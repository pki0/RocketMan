help_text_1 = "*Folgende Befehle kennt der Bot:*\n\n" + \
    ...
    "/radius 1000\n" + \
    "Stellt deinen Such-Radius in m (Metern) um deinen Standort herum ein. Hierbei ist 10000m das Maximum.\n\n" + \
    "*Sonstiges:*\n\n" + \
    "/speichern\n" + \
    ...
    "/nachricht\n" + \
    "Stellt die Art der Nachrichten um. Du hast die Wahl zwischen: Nur Standort oder Standort und einen zusätzlichen Text.\n" + \
    "/ende\n" + \
...
start_text = "Hallo *%s*.\nDein Bot ist nun im Einstellungsmodus. " + \
    ...
    "Benutzt du diesen Bot zum *ersten Mal*, dann sende bitte deinen Standort, der gemeldet werden soll oder sende deinen *Standort* einfach über Telegram oder nutze */standort xx.xx, yy.yy*, */standort Kiel, DE* oder " + \
